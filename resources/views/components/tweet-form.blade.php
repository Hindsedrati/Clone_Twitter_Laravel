@if(Auth::id())
    <div class="dark:bg-gray-800 overflow-hidden rounded-lg shadow-sm">
        ...
        @endif
            ...
            <div class="dark:bg-gray-700 rounded-lg w-full"  x-data="{ show: false }">
                ...
                <div class="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
                    ...
                    <div class="flex pl-0 space-x-1 sm:pl-2">
                        <button type="button" x-on:click="show = !show" class="font-medium hover:bg-gray-100 hover:text-gray-700 items-center px-4 py-2 rounded-lg text-center text-white text-xs">
                ...
                <div x-show="show">
                    <input type="file" name="files[]" class="filepond--tweet mb-0" data-max-file-size="3MB" multiple x-transition/>
                </div>
            </div>
        </form>
    </div>
